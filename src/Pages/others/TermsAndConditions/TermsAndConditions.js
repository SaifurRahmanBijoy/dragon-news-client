  ...
  return (
    <div className="shadow-sm p-3">
      ...
      <p>
        ...
        of Beast of news's Website, located at
        https://github.com/SaifurRahmanBijoy.
      </p>
      ...
      <p>
        ...
        use cookies in agreement with the Beast of news's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Beast of news and/or its licensors own the
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Beast
        of news does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Beast of news,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Beast of news shall not be
      ...
      <p>
        Beast of news reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Beast of news a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Beast of news; and (d) the link
      ...
      <p>
        ...
        e-mail to Beast of news. Please include your name, your organization
      ...
      <p>
        No use of Beast of news's logo or other artwork will be allowed for
